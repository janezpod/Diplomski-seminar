...
\begin{abstract}
    ...
    V delu predstavimo definicije in primere, ki motivirajo kodiranje in
...
\begin{primer}
    ...
    tabelo iz Slike~\refeq{fig:Morse}, dodatno presledek med besedami \_  kodiramo v sedem kratkih enot tišine 
    \[
        \kappa(\_) = \_\_\_
    \]
...
\begin{opomba}
    ...
    Kompresija z gramatikami je \textit{kodiranje brez izgube}, kjer velja
    \[
        \forall w \in \Sigma^* \colon \kappa^{-1}(\kappa(w)) = w
    \]
    Obstaja tudi \textit{kodiranje z izgubo}, kjer kodiranje ni reverzibilen proces
    in v grobem velja
    \[
