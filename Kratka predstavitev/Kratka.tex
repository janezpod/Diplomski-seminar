...
% Po zgorjni definiciji je kodiranje vedno obrnljivo? Torej je vsako kodiranje brez izgube?
...
\begin{primer}
    ...
    priredi besedo iz črk kodirne abecede. Funkcija je definirana s tabelo iz Slike~\refeq{fig:Morse},
...
\begin{primer}
    ...
    Formalizirajmo gramatiko iz Primera~\refeq{Kompresija}, ki smo jo generirali z besede
