...
\begin{primer}
    ...
    \[
        ...
        \Sigma_c = \{ \cdot ,-, \_ \}.
    \]
    Definirajmo kodno funkcijo črk abecede $ \kappa \colon \Sigma \to \Sigma_c^* $, ki vsaki črki iz abecede
    $ \Sigma $ priredi niz črk kodne abecede $ \Sigma_c $. Vrednosti funkcije $ \kappa $ so določene s
    ...
    \[
        --\cdot-- \,\, \cdot \,\, -\cdot\cdot.
    \]
    Sporočila ne znamo dekodirati, saj se ne nahaja v domeni $ C $ dekodne funkcije $ K^{-1} $.
