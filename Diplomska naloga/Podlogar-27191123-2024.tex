...
Predstavimo dva razreda prirejanja dopustne gramatike nizu in za vsak rrazred podamo primer
prirejanja. Za stiskanje niza $w$ z binarnim kodiranjem prepisovalnih pravil dopustne gramatike 
...
provide an example for each class. We analyze the redundancy in lossless compression of a 
string $w$ using a binary encoding of the production rules of the admissable grammar $G_w$ and
demonstrate that such compression constitutes a universal code.
}
